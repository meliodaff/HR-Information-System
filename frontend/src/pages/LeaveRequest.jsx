...
export default function LeaveRequest() {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div className="p-6 border-b border-gray-200">
              <h2 className="text-2xl font-bold text-center text-gray-900">REQUEST LEAVE</h2>
            </div>
            ...
            <div className="p-6 lg:p-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <div className="flex items-start gap-4 mb-6 p-4 bg-gray-50 rounded-lg">
                    <div className="w-24 h-24 rounded-lg overflow-hidden flex-shrink-0">
                        ...
                        />
                      <div className="text-white text-3xl font-bold">{employee.name.charAt(0)}</div>
                    </div>
                    <div className="flex-1">
                      <div className="mb-2">
                        <span className="font-semibold text-gray-700">Name:</span> <span className="text-gray-900">{employee.name}</span>
                      </div>
                      <div className="mb-2">
                        <span className="font-semibold text-gray-700">Position:</span> <span className="text-gray-900">{employee.position}</span>
                      </div>
                      <div>
                        <span className="font-semibold text-gray-700">Email:</span> <span className="text-gray-900">{employee.email}</span>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="font-semibold text-gray-700">Employee ID:</div>
                  ...
                  {errors.typeOfLeave && (
                    <p className="text-red-500 text-sm mb-2 -mt-4">{errors.typeOfLeave}</p>
                  )}
                        ...
                        <button
                          ...
                          className={`aspect-square flex items-center justify-center text-base font-medium rounded-lg transition-colors ${
                            day
                              ...
                              : 'text-gray-300'
                          } ${isSubmitted && day ? 'cursor-not-allowed opacity-50' : 'cursor-pointer'}`}
                        >
                          {day || ''}
                        </button>
                      ))}
                ...
                <div className="flex flex-col">
                  {/* Reason */}
                  <div className="mb-6">
                    <label className="block text-base font-semibold text-gray-700 mb-3">Reason:</label>
                    <textarea
                  ...
                  {/* Supporting Document */}
                  <div className="mb-8">
                    <label className="block text-base font-semibold text-gray-700 mb-3">Supporting Document</label>
                    <div className="flex gap-3">
                      ...
                      <label
                        ...
                        className={`flex-1 px-4 py-3 border border-gray-300 rounded-lg text-base text-gray-500 truncate ${
                          isSubmitted ? 'bg-gray-100 cursor-not-allowed' : 'cursor-pointer hover:bg-gray-50'
                        }`}
                      >
                        {formData.document ? formData.document.name : 'Document'}
                      </label>
                      <button
                        onClick={() => !isSubmitted && document.getElementById('document-upload').click()}
                        disabled={isSubmitted}
      ...
      <LeaveRequestModal isOpen={showSuccessModal} onClose={handleSuccessClose} />
    </>
  );
}