...
export default function EmployeeAnalytics({ employee }) {
  ...
  const lateOffset =
    ((presentPercentage + absentPercentage) / 100) * circumference;
                  ...
                  <div className="relative w-48 h-48 flex-shrink-0">
                    ...
                    >
                      ...
                      <circle
                        ...
                        strokeWidth="20"
                        strokeDasharray={`${
                          (presentPercentage / 100) * circumference
                        } ${circumference}`}
                        strokeDashoffset="0"
                      ...
                      <circle
                        ...
                        strokeWidth="20"
                        strokeDasharray={`${
                          (absentPercentage / 100) * circumference
                        } ${circumference}`}
                      ...
                      <circle
                        ...
                        strokeWidth="20"
                        strokeDasharray={`${
                          (latePercentage / 100) * circumference
                        } ${circumference}`}
              ...
              <div className="bg-white rounded-xl shadow-md p-6">
                ...
                <div className="relative h-48">
                  ...
                  >
                    ...
                    {/* Line path */}
                    <polyline
                      points={analyticsData.trends
                        .map((point, index) => {
                          const x =
                            (index / (analyticsData.trends.length - 1)) * 400;
                          const y =
                            200 - ((point.value - minValue) / range) * 180;
                          return `${x},${y}`;
                        })
                        .join(" ")}
                      fill="none"
                ...
                <p className="text-sm text-gray-600 mt-4">
                  You improved punctuality by{" "}
                  <span className="font-bold">
                    {analyticsData.improvement.percentage}%
                  </span>{" "}
                  {analyticsData.improvement.period}
                </p>
              </div>
            </div>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <div className="text-sm text-gray-600 sm:text-right">
                  <p>
                    ...
                    this{" "}
                    <span className="font-bold">
                      {analyticsData.rewards.targetMonth}
                    </span>{" "}
                    to earn a{" "}
