...
export default function Employees() {
  ...
  const [employees] = useState([
    {
      ...
      email: 'spherestar@gmail.com'
    },
    {
      id: 'VT-22345',
      name: 'Mean Arthur',
      position: 'ASSISTANT VET',
      email: 'meanarth@gmail.com'
    },
    {
      id: 'VT-32345',
      name: 'Juan Dela Cruz',
      position: 'GROOMER/STYLIST',
  ...
  if (selectedEmployee) {
    return <EmployeeInformation employee={selectedEmployee} onClose={handleCloseProfile} />;
  }
    ...
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 sm:mb-8">
          <h1 className="text-3xl sm:text-4xl font-black text-gray-900">EMPLOYEE</h1>
        </div>
